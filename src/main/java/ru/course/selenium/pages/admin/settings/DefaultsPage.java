 ...
 */
public class DefaultsPage extends BaseAdminPage {
    public static final String PAGE_TITLE_LOCAL = "Settings";
    public static final String LOCAL_URL = "/admin/?app=settings&doc=defaults";

    public DefaultsPage(WebDriver driver) {
        super(driver);
    }
